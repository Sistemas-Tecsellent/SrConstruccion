...
class OfertasMarcasWidget extends StatefulWidget {
  const OfertasMarcasWidget({Key key}) : super(key: key);

  @override
  _OfertasMarcasWidgetState createState() => _OfertasMarcasWidgetState();
}

class _OfertasMarcasWidgetState extends State<OfertasMarcasWidget> {
                                ...
                                child: PageView(
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: Image.asset(
                                        'assets/images/Banner_Oferta_1_(5).png',
                                        width: 100,
                                        height: 200,
                                        fit: BoxFit.cover,
                                      ),
