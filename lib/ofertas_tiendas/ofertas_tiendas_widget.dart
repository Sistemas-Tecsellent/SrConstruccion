...
class OfertasTiendasWidget extends StatefulWidget {
  const OfertasTiendasWidget({Key key}) : super(key: key);

  @override
  _OfertasTiendasWidgetState createState() => _OfertasTiendasWidgetState();
}

class _OfertasTiendasWidgetState extends State<OfertasTiendasWidget> {
                ...
                StreamBuilder<List<StoresRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Column(
                      mainAxisSize: MainAxisSize.max,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: List.generate(columnStoresRecordList.length,
                          (columnIndex) {
