...
class ProductosPedidoProgramadoWidget extends StatefulWidget {
  const ProductosPedidoProgramadoWidget({Key key}) : super(key: key);

  @override
  _ProductosPedidoProgramadoWidgetState createState() =>
      _ProductosPedidoProgramadoWidgetState();
}

class _ProductosPedidoProgramadoWidgetState
    extends State<ProductosPedidoProgramadoWidget> {
  @override
