        ...
        Align(
          ...
          child: StreamBuilder<List<ProductsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              return InkWell(
                onTap: () async {
                  if ((containerProductsRecord.owner) == 'srconstruccion') {
                    context.pushNamed(
                      'ProductPage',
                      params: {
                        'productId': serializeParam(
                            containerProductsRecord.id, ParamType.String),
                      }.withoutNulls,
                    );
                  } else {
                    context.pushNamed(
                      ...
                      params: {
                        'storeName': serializeParam(
                            containerProductsRecord.ownerName,
                            ParamType.String),
                        'productId': serializeParam(
                            containerProductsRecord.id, ParamType.String),
                      }.withoutNulls,
                      queryParams: {
                        'storeId': serializeParam(
                            containerProductsRecord.owner, ParamType.String),
                      }.withoutNulls,
                    );
                  }
                },
                child: Container(
                  ...
                  child: StreamBuilder<List<VariantsRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<VariantsRecord> rowVariantsRecordList =
                          snapshot.data;
