...
class MisPedidosWidget extends StatefulWidget {
  const MisPedidosWidget({Key key}) : super(key: key);

  @override
  _MisPedidosWidgetState createState() => _MisPedidosWidgetState();
}
        ...
        child: GestureDetector(
          ...
          child: AuthUserStreamWidget(
            child: Builder(
              builder: (context) {
                final orderBundle =
                    (currentUserDocument?.liveOrders?.toList() ?? [])
                            ?.toList() ??
                        [];
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children:
                        List.generate(orderBundle.length, (orderBundleIndex) {
                      final orderBundleItem = orderBundle[orderBundleIndex];
                      return Padding(
                              ...
                              child: StreamBuilder<List<OrderBundlesRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<OrderBundlesRecord>
                                      containerOrderBundlesRecordList =
                                      snapshot.data;
                                  final containerOrderBundlesRecord =
                                      containerOrderBundlesRecordList.isNotEmpty
                                          ? containerOrderBundlesRecordList
                                              .first
                                          : null;
                                  return Container(
